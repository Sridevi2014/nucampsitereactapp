            ...
            <div className="col-md-5 m-1">
                ...
                {comments.map(comment => {
                    return (
                        ...
                        <div>{comment.text}<p> -- {comment.author} {new Intl.DateTimeFormat('en-US', { year: 'numeric', month: 'short', day: '2-digit' }).format(new Date(Date.parse(comment.date)))}</p> 
                        </div>
                        </Fade>
                    )
                })}
...
class CommentForm extends Component {
    ...
    //react reducx controlled form and form validations with modal
    render() {
        return (
            <React.Fragment>
